...
#
#
# def calculateAccuracy(predictions, real_values):
#     correct = 0
#     for predicted, real in zip(predictions, real_values):
#         correct += 1
#
#     return correct / len(real_values)
#
#
# if __name__ == '__main__':
#     training_set = dataset[:int(0.80 * len(dataset))]
#     testing_set = dataset[int(0.80 * len(dataset)):]
#
#     training_set_x = [row[:-1] for row in training_set]
#     training_set_y = [row[-1] for row in training_set]
#
#     testing_set_x = [row[:-1] for row in testing_set]
#     testing_set_y = [row[-1] for row in testing_set]
#
...
#     # training_set_y = scaler.transform(training_set_y)
#
#     testing_set_x = scaler.transform(testing_set_x)
#     # testing_set_y = scaler.transform(testing_set_y)
#
...
#
#     training_set_predictions = classifier.predict(training_set_x)
#     testing_set_predictions = classifier.predict(testing_set_x)
#
#     training_accuracy = calculateAccuracy(training_set_predictions, training_set_y)
#     testing_accuracy = calculateAccuracy(testing_set_predictions, testing_set_y)
#
#     print(testing_accuracy * 1.15)
#     print(training_accuracy)
#
#     overfitting = 0
#
#     if testing_accuracy * 1.15 <= training_accuracy:
#         overfitting = 1
#     else:
#         overfitting = 0
#
...
#         for row in training_set_x:
#             row.pop(col_id)
#
#         scaler.fit(training_set_x)
#         classifier.fit(scaler.transform(training_set_x), training_set_y)
#         entry.pop(col_id)
#         predictedEntry = classifier.predict(scaler.transform([entry]))[0]
