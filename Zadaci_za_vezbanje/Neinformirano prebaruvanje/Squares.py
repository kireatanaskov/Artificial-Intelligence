    ...
    def successor(self, state):
        ...
        for dir in self.moves:
            ...
            if Squares.check_valid_square(newPos):
                successors[f"Pomesti kvadratche {1} {dir}"] = tuple(tmp)
        ...
        for dir in self.moves:
            ...
            tmp[1] = newPos
            if Squares.check_valid_square(newPos):
                successors[f"Pomesti kvadratche {2} {dir}"] = tuple(tmp)
        ...
        for dir in self.moves:
            ...
            tmp[2] = newPos
            if Squares.check_valid_square(newPos):
                successors[f"Pomesti kvadratche {3} {dir}"] = tuple(tmp)
        ...
        for dir in self.moves:
            ...
            tmp[3] = newPos
            if Squares.check_valid_square(newPos):
                successors[f"Pomesti kvadratche {4} {dir}"] = tuple(tmp)
        ...
        for dir in self.moves:
            ...
            tmp[4] = newPos
            if Squares.check_valid_square(newPos):
                successors[f"Pomesti kvadratche {5} {dir}"] = tuple(tmp)
