...
class Topchinja(Problem):
    ...
    def successor(self, state):
        ...
        for point in points:
            ...
            # Gore levo
            if (x - 1, y + 1) in temp:  # ako ima topce GORE LEVO od momentalnata topce
                newState = move(point, "upleft")  # preskokaj go topceto sto e gore levo
                if self.check_valid(newState, temp):  # proveri dali e validna novata sostojba
                    temp.remove((x - 1, y + 1))  # izbrisi go topceto GORE LEVO od momentalnoto topce
                    temp.remove(point)  # izbrisi go momentalnoto topce
                    temp.append(newState)  # dodai go novoto
                    successors[f"Gore Levo: (x={x},y={y})"] = tuple(temp)
            ...
            if (x + 1, y + 1) in temp:
                ...
                if self.check_valid(newState, temp):
                    ...
                    successors[f"Gore Desno: (x={x},y={y}"] = tuple(temp)
            ...
            if (x - 1, y - 1) in temp:
                ...
                if self.check_valid(newState, temp):
                    ...
                    temp.remove(point)
                    temp.append(newState)
                    successors[f"Dole Levo: (x={x},y={y}"] = tuple(temp)
            ...
            if (x + 1, y - 1) in temp:
                ...
                if self.check_valid(newState, temp):
                    ...
                    temp.remove(point)
                    temp.append(newState)
                    successors[f"Dole Desno: (x={x},y={y}"] = tuple(temp)
            ...
            if (x - 1, y) in temp:
                ...
                if self.check_valid(newState, temp):
                    ...
                    temp.remove(point)
                    temp.append(newState)
                    successors[f"Levo: (x={x},y={y}"] = tuple(temp)
            ...
            if (x + 1, y) in temp:
                ...
                if self.check_valid(newState, temp):
                    ...
                    temp.remove(point)
                    temp.append(newState)
                    successors[f"Desno: (x={x},y={y}"] = tuple(temp)
    ...
    def check_valid(self, point, points):
        ...
        if point in self.obstacles or point in points: return False
...
if __name__ == "__main__":
    ...
    problem = Topchinja(obstacles, n, points)
